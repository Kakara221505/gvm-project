  ...
  return (
    <div className='app-navbar flex-shrink-0'>
      ...
      <div className={clsx('app-navbar-item', itemClass)}>
        ...
        <div className='me-4'>
          <button style={stylesTransBtn} type='button' className='py-5  btn btn-default'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='18'
              height='20'
        ...
        <div className='dropdown'>
          <button
            ...
            className='pt-2 pb-2 d-flex align-items-center btn btn-secondary dropdown-toggle'
            type='button'
          ...
          >
            <div className='d-flex'>
              <div className='d-flex flex-column justify-content-center align-items-end me-5'>
                <small className='text-black fs-4'>John Doe</small>
