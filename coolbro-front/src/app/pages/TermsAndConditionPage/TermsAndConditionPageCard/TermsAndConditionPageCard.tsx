...
import { TermsAndConditionPageCardStyles } from './TermsAndConditionPageCardStyles'

const TermsAndConditionPageCard: FC = () => {
  return (
    <TermsAndConditionPageCardStyles>
      <div className='row bg-white mx-0 align-items-center mobilePaddingNone  py-20 pb-5 px-6'>
        <div className='col-lg-12 commonMobilePX px-10'>
          <div className='innerContactusSection'>
            <h1 className='primaryTextMediumBold textAlignCenterMobile'>TERMS AND CONDITIONS</h1>
          ...
          <div className='innerContactusSection my-10'>
            <h1 className='primaryTextMediumBold'>INTENDED USE OF WEBSITE</h1>
            <p className='my-5 fs-4 justifyText'>
          ...
          <div className='innerContactusSection my-10'>
            <h1 className='primaryTextMediumBold'>USER REGISTRATION</h1>
            <p className='my-5 fs-4 justifyText'>
          ...
          <div className='innerContactusSection my-10'>
            <h1 className='primaryTextMediumBold'>REGISTERED ACCOUNT OBLIGATIONS</h1>
            <p className='my-5 fs-4 justifyText'>
          ...
          <div className='innerContactusSection my-10'>
            <h1 className='primaryTextMediumBold'>CONTENT USE LIMITATIONS</h1>
            <p className='my-5 fs-4 justifyText'>
          ...
          <div className='innerContactusSection my-10 mb-10'>
            <h1 className='primaryTextMediumBold'>PROSPECTIVE INVESTOR ACCOUNTS</h1>
            <p className='my-5 fs-4 justifyText'>
...
export default TermsAndConditionPageCard
