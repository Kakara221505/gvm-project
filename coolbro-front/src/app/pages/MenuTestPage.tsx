      ...
      <div className='card card-custom'>
        <div className='card-body p-9'>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    className='menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-100 w-lg-225px m-0'
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className='menu-sub menu-sub-accordion menu-sub-lg-dropdown menu-active-bg py-4 w-100 w-lg-225px m-0'
                ...
                >
                  ...
                  <div
                    className='menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown w-100 w-lg-600px p-5 p-lg-5 m-0'
          ...
          <div className='mb-20 w-200px'>
            ...
            <div
              className='menu menu-sub menu-sub-dropdown w-250px w-lg-300px px-7 py-5 m-0'
              data-kt-menu='true'
