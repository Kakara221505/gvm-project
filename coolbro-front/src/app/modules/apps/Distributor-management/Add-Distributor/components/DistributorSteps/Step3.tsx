...
const Step3: FC<Step3Props> = ({editFlag,editDistributor}) => {
  ...
  useEffect(() => {
    if (editFlag) {
      setSelectedOption(editDistributor?.AddressDetails[0]?.Country)
      formik.setFieldValue('Address', editDistributor?.AddressDetails[0]?.Address)
      formik.setFieldValue('City', editDistributor?.AddressDetails[0]?.City)
      formik.setFieldValue('State', editDistributor?.AddressDetails[0]?.State)
      formik.setFieldValue('Country', editDistributor?.AddressDetails[0]?.Country)
      formik.setFieldValue('Phone_number', editDistributor?.User?.Phone)
      formik.setFieldValue('Phone_number_2', editDistributor?.User?.Phone)
      formik.setFieldValue('PostalCode', editDistributor?.AddressDetails[0]?.PostalCode)
      setLat(editDistributor?.UserDetails?.Latitude)
      setLng(editDistributor?.UserDetails?.Longitude)
      formik.setFieldValue('Latitude', editDistributor?.UserDetails?.Latitude)
      formik.setFieldValue('Longitude', editDistributor?.UserDetails?.Longitude)
    }
