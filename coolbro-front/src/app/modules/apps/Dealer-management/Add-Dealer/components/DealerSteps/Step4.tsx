...
const Step4: FC<Step4Props> = ({editDealer, editFlag}) => {
  ...
  useEffect(() => {
    if (editFlag) {
      formik.setFieldValue(
        'Account_holder_name',
        editDealer?.BankAccountDetails?.Account_holder_name
      )
      formik.setFieldValue('Account_number', editDealer?.BankAccountDetails?.Account_number)
      formik.setFieldValue('UPI_id', editDealer?.UserDetails?.UPI_id)
      formik.setFieldValue('IFSC_code', editDealer?.BankAccountDetails?.IFSC_code)
      formik.setFieldValue('Bank_name', editDealer?.BankAccountDetails?.Bank_name)
      formik.setFieldValue('Branch', editDealer?.BankAccountDetails?.Branch)
    }
  }, [editDealer, editFlag])
        ...
        <div className='col-lg-12  mobilePaddingNone'>
          <div className='card boxNavPills'>
            <div className='card-body pb-0 pt-0 px-0'>
              <div className=''>
                <div className='fv-row mb-8 paddingPagePXMobile d-block input-group  form-group'></div>
