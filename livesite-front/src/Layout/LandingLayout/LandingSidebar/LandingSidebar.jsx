...
export default function LandingSidebar({
  ...
  handleNavigation,
  activeComponent,
  showView, // Add showView function prop
}) {
      ...
      <div className="d-flex flex-column ">
        <div className="d-flex flex-column ">
          ...
          <div className="sideMenuSection my-3">
            ...
            <a
              className={`d-flex cursor-pointer align-items-center menuTextHeader ${
                activeComponent === "AdminUserList" ? "active" : ""
              } ${darkMode ? "dark-mode" : ""}`}
            ...
            {isLogin && (
              ...
              activeComponent === "CreateProject" ? "active cursor-pointer" : ""
            } ${darkMode ? "dark-mode" : ""}`}
          >
                <svg width="24" height="24"          className="me-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M12 4V20M20 12H4"    stroke="var(--text-secondary)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

                  Create Project
                </a> */}
                {/* <a
                  onClick={() => handleNavigation("LandingProjects")}
                  className={`d-flex align-items-center cursor-pointer ${
                    activeComponent === "LandingProjects"
            ...
            {isLogin && (
              <>
                <a
                  onClick={() => handleNavigation("LandingOrganization")} // Set active component to LandingProfile
                ...
                <a
                  onClick={() => handleNavigation("LandingUserSettings")} // Set active component to LandingProfile
                  className={`d-flex align-items-center cursor-pointer menuTextHeader ${
