...
export default function TermsAndConditions() {
  return (
    <main className="wrap">
      <section className="container1 rounded-4 commonModalBg">
        <div className="container__heading">
          <h4 className="yellowText fw-bold text-start">Terms & Conditions</h4>
        </div>
        <div className="container__content custom-scrollbar menuTextHeader">
        ...
        <div className="container__nav d-flex justify-content-between align-items-center">
          <div>
            <input type="checkbox" className="mx-2" />
            <small className="menuTextHeader">By clicking 'Accept' you are agreeing to our terms and conditions.</small>
          </div>
