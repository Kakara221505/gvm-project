...
const Login = ({
  ...
  const handleSubmit = (values) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_PUBLIC_BASE_URL}auth/login_with_password`,
        values
      )
      .then((response) => {
        const userRole =
          response?.data?.User?.User_type === 0
            ? "ADMIN"
            : response?.data?.User?.User_type === 1
            ? "USER"
            : "ORGANIZATION";
                    ...
                    <form className="px-0 mx-0 " onSubmit={formik.handleSubmit}>
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <label
                          ...
                          className={`form-check-label yellowText cursor-pointer ${
                            darkMode ? "dark-mode" : ""
                          }`}
                        >
                          Forgot Password?
                      ...
                      <button
                        className="loginBtn1 w-100 my-4 rounded-2 btn btn-primary"
                        type="submit"
                      ...
                      <div className="text-center d-flex justify-content-center">
                        ...
                        <label
                          className={`px-2 loginTextColor1  form-check-label cursor-pointer yellowButtonColor ${
                            darkMode ? "dark-mode" : ""
                          }`}
