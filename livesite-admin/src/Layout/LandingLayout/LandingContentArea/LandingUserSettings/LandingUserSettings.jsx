...
export default function LandingUserSettings() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await axios.get(
        `${process.env.REACT_APP_PUBLIC_BASE_URL}users/getAllUser`,
        {
          headers: {
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        if (editUserId) {
          ...
          let { confirmPassword, ...payloadWithoutConfirmPassword } = values;
          payloadWithoutConfirmPassword = {
            ...payloadWithoutConfirmPassword,
            Role : payloadWithoutConfirmPassword.Role === 0 ? "Advance_User" : payloadWithoutConfirmPassword.Role === 1 ? "Basic_User" : "External_User"
          }
          setShowModal(false);
          await axios.put(
          ...
          // Exclude confirmPassword from the new user payload
          let { confirmPassword, ...payloadWithoutConfirmPassword } = values;
          payloadWithoutConfirmPassword = {
            ...payloadWithoutConfirmPassword,
            Role : payloadWithoutConfirmPassword.Role === 0 ? "Advance_User" : payloadWithoutConfirmPassword.Role === 1 ? "Basic_User" : "External_User"
  ...
  return (
    <div className="LandingUserSettings py-3 px-3">
      ...
      >
        <Modal.Header
          className="commonModalBg border-0 py-3 pb-0"
          closeButton
        ></Modal.Header>
              ...
              <div className="d-flex gap-4 mt-1">
                ...
                <div>
                  <input
                    ...
                    style={{ width: "15px", height: "15px" }}
                  />
                  <label className="ms-1">Advanced User</label>
                </div>
                <div>
                  <input
                    type="radio"
                    ...
                    style={{ width: "15px", height: "15px" }}
                  />
                  <label className="ms-1">External User</label>
                </div>
              </div>
