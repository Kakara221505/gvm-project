    ...
    <div className="recentDesignCards py-3 px-3">
      <div className="d-flex justify-content-between py-3 pt-0 align-items-center">
        ...
        <div className="d-flex justify-content-end mb-3">
          ...
          <div
            className={`px-2 cursor-pointer ${viewMode === "grid" ? "activeRecent" : ""
              }`}
          ...
          <div
            className={`px-2 cursor-pointer ${viewMode === "list" ? "activeRecent" : ""
              }`}
              ...
              <table className="table table-image bg-transparent">
                <thead className="bg-transparent">
                  <tr className="border-0">
                    <th
                      className="lightText fw-normal text-start px-3 bg-transparent"
                      scope="col"
                    >
                      Name
                    </th>
                    ...
                    <tr key={project.ID} className="border-0">
                      <td className="w-25 lightText text-start bg-transparent">
                        <img
                          ...
                          alt={project.Name}
                        />
                        <span className="tdKLi  px-3 mb-0 pb-0">{project.Name}</span>
                      </td>
