...
export default function EditOrganization({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      ...
      try {
        ...
        Object.keys(values).forEach((key) => {
          if (
            key !== "ProfileMedia" &&
            key !== "ProfileMediaPreview" &&
            key !== ""
          ) {
            formData.append(key, values[key]);
          }
        });
        if (values.ProfileMediaPreview) {
          formData.append("ProfileMedia", values.ProfileMediaPreview);
        }
        const response = await axios.put(
          `${process.env.REACT_APP_PUBLIC_BASE_URL}organization/${viewOrganizationProfile.ID}`,
          formData,
  ...
  useEffect(() => {
    ...
    formik.setValues({
      First_name: viewOrganizationProfile.First_name,
      Last_name: viewOrganizationProfile.Last_name,
      Email: viewOrganizationProfile.Email,
      Phone: viewOrganizationProfile.Phone,
      Key_name: viewOrganizationProfile.Key_name,
      // Contact_person_name: organization.Contact_person_name,
      Address: viewOrganizationProfile.Address,
      City: viewOrganizationProfile.City,
      State: viewOrganizationProfile.State,
      Country: viewOrganizationProfile.Country,
      Website: viewOrganizationProfile.Website,
      Organization_name: viewOrganizationProfile.Organization_name,
      Date_of_birth: viewOrganizationProfile.Date_of_birth
        ? formatDateOfBirth(viewOrganizationProfile.Date_of_birth)
        : "",
      Postal_code: viewOrganizationProfile.Postal_code,
      ProfileMediaPreview: `${process.env.REACT_APP_PUBLIC_BASE_URL}${viewOrganizationProfile.Profile_image_url}`,
      // Add other fields as needed
    });
  }, []);
        ...
        <div className="col-lg-12">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex flex-column">
              <h3 className="text-start menuTextHeader fw-bold">
                Organization
              </h3>
            ...
            <div className="row py-4">
              <div className="col-lg-4 d-flex justify-content-center align-items-center border-end">
                <div className="avtarSec">
                  ...
                  <div className="py-2">
                    <h3 className="py-1 menuTextHeader">Web-designer</h3>
              ...
              <div className="col-lg-8 px-4">
                <div className="orgHeading  py-3 border-bottom">
                  <h5 className="text-start  menuTextHeader fw-bold">
                ...
                <div className="formStart py-3 pb-0 px-3">
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="d-flex ml-auto justify-content-end pt-5 pe-5">
                      <button
      ...
      >
        ...
        <Modal.Body className="commonModalBg">
          ...
          <form className="px-5">
            ...
            <button
              type="submit"
              className="btn btn-primary loginBtn1 w-100 my-4 py-2"
            >
              Submit
            </button>
          </form>
