...
export default function ProjectListPage({ toggleProjectPage, darkMode }) {
  // State to track the current view mode
  const [viewMode, setViewMode] = useState("grid");
  const { theme } = useContext(ThemeContext);
 // Static project data
 const projects = [
    { ID: 1, Name: "Project A", Created_at: "2024-09-01T12:00:00Z" },
    { ID: 2, Name: "Project B", Created_at: "2024-09-05T12:00:00Z" },
    { ID: 3, Name: "Project C", Created_at: "2024-09-10T12:00:00Z" },
      ...
      {!loading && projects.length > 0 && (
        <div className="d-flex justify-content-between py-3 pt-0 align-items-center">
          <div className="d-flex align-items-center">
            <h5
              className={`text-start menuTextHeader mb-0  fw-bold ${
                darkMode ? "dark-mode" : ""
              }`}
            >
              Project List
          ...
          <div className="d-flex align-items-center justify-content-end mb-3">
            ...
            <div className='px-2 cursor-pointer position-relative d-flex align-items-center'>
                <input type="search" className="form-control rounded-5 py-2 ps-5" placeholder="Search"/>
            <i className="fa fa-search  position-absolute ms-3"/>
                </div>
            <div className='px-2 cursor-pointer'>
                            <button className="btn btn-primary mx-3"  onClick={handleShowModal}>User <i className="fa fa-filter px-1 "/></button>
                </div>
            <div
