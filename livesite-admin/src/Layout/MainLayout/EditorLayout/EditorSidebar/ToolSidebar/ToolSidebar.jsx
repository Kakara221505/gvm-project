...
export default function ToolSidebar({ setShapeToDraw, openPropertySidebar }) {
  ...
  useEffect(() => {
    if (propertySidebarOpen && selectedObject) {
      ...
      !showShapesMenu &&
      ["Triangle", "Hexagon", "Star"].includes(activeIcon)
    ) {
  ...
  }, [propertySidebarOpen, showShapesMenu, activeCanvas, selectDate]);
    ...
    <section className="ToolSidebar">
      <div className="row">
        <div className="col-lg-12 px-1">
          <div className="iconBar" style={getDisableStyle(!isProjecteEditable)}>
            <OverlayTrigger
              placement="right"
              overlay={
              ...
              >
                <a
                  className={`cursor-pointer border-2  border-bottom ${
                    activeIcon === "select" ? "active rounded-2" : ""
                  }`}
                >
                  <svg
                    width="24"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={activeIcon === "select" ? "fillImg4" : ""}
                  >
                    <path
            ...
            {/* <div onClick={() => handleShapeClick("FreeForm")}>
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      d="M20.4215 21C20.6828 22.182 21.5116 24.1956 20.5398 25.268C19.8765 26 18.6288 26 16.1335 26L15.8665 26C13.3712 26 12.1235 26 11.4602 25.268C10.4884 24.1956 11.3172 22.182 11.5785 21"
                      stroke="var(--text-secondary)"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M22.0068 13.3474L17.7868 7.6416C16.9774 6.5472 16.5726 6 16 6C15.4274 6 15.0227 6.5472 14.2132 7.6416L9.99325 13.3474C9.31656 14.2623 8.97821 14.7198 9.00109 15.2073C9.02396 15.6948 9.47593 16.2054 10.3799 17.2268C11.2511 18.2112 11.5785 19.2305 11.5785 20.9995L20.4215 21C20.4215 19.231 20.7493 18.2114 21.6203 17.2269C22.5242 16.2053 22.9761 15.6946 22.9989 15.2071C23.0217 14.7197 22.6834 14.2623 22.0068 13.3474Z"
                      stroke="var(--text-secondary)"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M17.5 14C17.0587 13.682 16.5464 13.5 16 13.5M16 13.5C15.4536 13.5 14.9413 13.682 14.5 14M16 13.5L16 6"
                      stroke="var(--text-secondary)"
                      strokeLinecap="round"
                    />
                  </svg>
            ...
            <div onClick={() => handleShapeClick("FreeForm")}>
              ...
              >
                <a
                  className={`${
                    activeIcon === "FreeForm" ? "active rounded-2" : ""
                  }`}
                >
                  <svg
                    width="24"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={activeIcon === "FreeForm" ? "fillImg4" : ""}
                  >
                    <circle
                      cx="9"
                      cy="4"
            ...
            <div onClick={() => handleShapeClick("Rectangle")}>
              ...
              >
                <a
                  className={`${
                    activeIcon === "Rectangle" ? "active rounded-2" : ""
                  }`}
                >
                  <svg
                    width="24"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={activeIcon === "Rectangle" ? "fillImg4" : ""}
                  >
                    <path
            ...
            <div onClick={() => handleShapeClick("circle")}>
              ...
              >
                <a
                  className={`${
                    activeIcon === "circle" ? "active rounded-2" : ""
                  }`}
                >
                  <svg
                    width="24"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={activeIcon === "circle" ? "fillImg4" : ""}
                  >
                    <circle
                      cx="12"
                      cy="12"
            ...
            <div onClick={() => handleShapeClick("line")}>
              ...
              >
                <a
                  className={`${
                    activeIcon === "line" ? "active rounded-2" : ""
                  }`}
                >
                  <svg
                    width="16"
                    ...
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className={activeIcon === "line" ? "fillImg4" : ""}
                  >
                    <path
                    ...
                    <ul className="shapes-menu list-unstyled py-2 px-2 position-absolute top-0 start-100 bg-white rounded-2 border">
                      {shapesDropdownItems.map((shape, index) => (
                        ...
                        >
                          ...
                          <label
                            className={`menuTextHeader  fs-6 ps-1 cursor-pointer ${
