...
import titleGlobal from "../../../../../../Common/titleGlobal";
...
export default function TitleSettings() {
  ...
  const handleAddTitle = async () => {
    ...
    if (selectedObject.title) {
      const UserID = selectedObject.title.UserID;
      const LayerID = selectedObject.title.LayerID;
      const PageID = selectedObject.title.PageID;
      const ID = selectedObject.title.ID;
      const titleLabel = selectedObject.title.label;
      const AssignDate = selectedObject.title?.AssignDate;
      const CategoryID = selectedObject.title?.CategoryID;
      const SubCategoryID = selectedObject.title?.SubCategoryID;
      const ParentAnnotationID = selectedObject.title?.ParentAnnotationID;
      const parentSelectSpecialId = selectedObject.title?.parentSelectSpecialId;
      const isPasteSpecialParent = selectedObject.title?.isPasteSpecialParent;
      let titleShape = selectedObject.title?.toObject();
      ...
      // const res = await titleGlobal(token, payload);
    }
  };
